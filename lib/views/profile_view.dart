                ...
                return CircleAvatar(
                    ...
                    child: ClipOval(
                        child: SizedBox(
                            width: 180, height: 180,
                            child: CircleAvatar(
                                backgroundImage: NetworkImage(_uploadFileUrl,),
                            )
                        ),
                    ),
                );
                    ...
                    child: Padding(
                        ...
                        child: Row(
                            ...
                            children:[
                                ...
                                SizedBox(width: 10,),
                                Container(
                                    child: Text(" ${user.displayName?? "Anonymous"}",style: TextStyle(fontSize: 20,),),
                ...
                children: [
                    ...
                    Row(
                        ...
                        children: [
                            ...
                            RaisedButton(
                                color: Colors.orange,
                                child: Text("Annuler",style: TextStyle(color: Colors.white,fontSize: 18),),
                                onPressed: (){
    ...
    Future uploadFile (BuildContext context,snapshot) async {
        ...
        storageReference.getDownloadURL (). then ((fileURL) {
            setState (() {
                ...
                Scaffold.of(context).showSnackBar(SnackBar(content: Container(child: Text("Image Uploaded"),),));
            });
        });
